...
- Improve null check for routingQueue property ([2f9f789](https://github.com/Modest-Human-Brands/mdoc/commit/2f9f789))
...
- Streamline project data retrieval and improve error handling ([ab9a931](https://github.com/Modest-Human-Brands/mdoc/commit/ab9a931))
...
- **api:** Make certificate fields optional in signing session and schema ([36ed6db](https://github.com/Modest-Human-Brands/mdoc/commit/36ed6db))
...
- **pdf:** Set worker source for PDF.js to ensure proper rendering ([de12a2b](https://github.com/Modest-Human-Brands/mdoc/commit/de12a2b))
...
- Rename 'title' to 'role' in contract schema and placeholders ([232749e](https://github.com/Modest-Human-Brands/mdoc/commit/232749e))
...
- Add advance percentage to contract schema and calculations ([a339853](https://github.com/Modest-Human-Brands/mdoc/commit/a339853))
...
[compare changes](https://github.com/Modest-Human-Brands/mdoc/compare/v0.1.16...v0.1.17)

### 💅 Refactors

- Enhance contract & quotation templates, additional organization details and dynamic terms ([0b14c5b](https://github.com/Modest-Human-Brands/mdoc/commit/0b14c5b))
